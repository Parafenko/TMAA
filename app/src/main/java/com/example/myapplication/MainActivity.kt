                ...
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    Column(
                        ...
                        Column(
                            ...
                            MakeSpellsLine(
                                name1 = Levels.Level1.exp, name2 = Levels.Level2.exp,
                                onvaluesetter = viewModel::valuesetter,
                                getSpellsbyLevel = viewModel::getSpellsbyLevel,
                                spellAdder = viewModel::spellAdder
                            )
                            MakeSpellsLine(
                                name1 = Levels.Level3.exp, name2 = Levels.Level4.exp,
                                onvaluesetter = viewModel::valuesetter,
                                getSpellsbyLevel = viewModel::getSpellsbyLevel,
                                spellAdder = viewModel::spellAdder
                            )
                            MakeSpellsLine(
                                name1 = Levels.Level5.exp, name2 = Levels.Level6.exp,
                                onvaluesetter = viewModel::valuesetter,
                                getSpellsbyLevel = viewModel::getSpellsbyLevel,
                                spellAdder = viewModel::spellAdder
                            )
                            MakeSpellsLine(
                                name1 = Levels.Level7.exp, name2 = Levels.Level8.exp,
                                onvaluesetter = viewModel::valuesetter,
                                getSpellsbyLevel = viewModel::getSpellsbyLevel,
                                spellAdder = viewModel::spellAdder
                            )
                            MakeSpellsLine(
                                name1 = Levels.Level9.exp, name2 = null,
                                onvaluesetter = viewModel::valuesetter,
                                getSpellsbyLevel = viewModel::getSpellsbyLevel,
                                spellAdder = viewModel::spellAdder
                            )
